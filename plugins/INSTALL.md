...
This archive contains demo-builder, demo-builder-generate-data, and demo-builder-style-guidelines. Install all
three from the same release. Keep companies.csv and names.csv beside demo-builder-generate-data/SKILL.md and
...
- Read both approved CSVs through the installed demo-builder-generate-data skill and verify usable records.
- For Cowork, open all three presenter, quality, and technology references.
- Verify the skills appear in Scout's skill registry and can be loaded in the current session.
- If possible, the user may confirm discovery in a new conversation manually.
